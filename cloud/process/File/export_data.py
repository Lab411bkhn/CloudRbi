...
def excelExport(idx, status):
    ...
    if rank == 5:
        ...
        if dataP is not None:
            ...
            worksheet.write('V3', convertDF(dataP['pof_catalog']), formatdata)
            ...
            worksheet1.write('V3', dataP['pof_catalog'], formatdata)
        ...
        if dataC is not None:
            ...
            worksheet.write('T3', convertDF(0), formatdata)
            worksheet.write('U3', convertDF(0), formatdata)
            worksheet.write('V3', convertDF(dataC['pof_catalog']), formatdata)
        ...
        if dataE is not None:
            for dataC in dataE:
                if dataC is not None:
                    ...
                    worksheet.write('V' + str(ind), convertDF(dataC['pof_catalog']), formatdata)
